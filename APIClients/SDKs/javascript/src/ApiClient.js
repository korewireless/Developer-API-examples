...
export default class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default https://client.api.korewireless.com
         */
        this.basePath = 'https://client.api.korewireless.com'.replace(/\/+$/, '');
        ...
        this.authentications = {
            'LambdaTokenAuthorizer': {type: 'apiKey', 'in': 'header', name: 'Unused'},
